...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("<u>foo<b>bas</b>    bar</u>", "<u>foo<b>bas</b> bar</u>"),
        ("<u>foo   bar</u>", "<u>foo bar</u>"),
        ("<u>foo <u>bar</u></u>", "<u>foo bar</u>"),
        ("<u>foo <ins>bar</ins></u>", "<u>foo <ins>bar</ins></u>"),
        ("<u>foo <u>bar</u> <b>bas</b></u>", "<u>foo bar <b>bas</b></u>"),
